...
/* Forward declaration of task group from async.c */
...
/* yona_rt_async_spawn_closure is defined in async.c which is #included before
 * channel.c, so the function is already in scope. We use it directly without
